...
base_arg = ' --T 100000 --env taobao --resultfoldertail _ctr_taobao_{} '.format(now)

if os.path.exists('./real_datasets/taobao/preprocess/X0_taobao.npy'):
...
for seed in seed_list:
    if os.path.exists('./real_models/AE_taobao_s{}.pt'.format(seed)):
...
real_plotting.plotting(resultfoldertail='_ctr_taobao_{}'.format(now), env='taobao', plotting_dict=plotting_dict, fnametail='_{}_all'.format(now))