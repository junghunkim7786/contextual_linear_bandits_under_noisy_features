...
createDirectory('./real_datasets/avazu/preprocess/')

createDirectory('./real_datasets/ml-100k/raw/')
os.system('unzip ./real_datasets/ml-100k.zip -d ./real_datasets/ml-100k/raw/')
createDirectory('./real_datasets/ml-100k/preprocess/')
